...
public class PrefUtils {
    ...
    public static void putString(String key, String value) {
        SharedPreferences config = UIUtils.getContext().getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
     ...
     * 设置缓存时间戳
     */
    private static void setCacheTime(int key) {
        SharedPreferences.Editor edit = UIUtils.getContext().getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE).edit();
        edit.putLong("CacheTime[" + key + "]", System.currentTimeMillis());
        edit.apply();
    }
    ...
    public static long getCacheTime(int key) {
        SharedPreferences config = UIUtils.getContext().getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
        return config.getLong("CacheTime[" + key + "]", -1);
    }

    public static void setCache(int key,Object obj){
        //设置缓存时间
        setCacheTime(key);
        //缓存
        saveObject("movieCache" + key,obj);
    }
    public static Object getCache(int key){
        return readObject("movieCache"+key);
    }
