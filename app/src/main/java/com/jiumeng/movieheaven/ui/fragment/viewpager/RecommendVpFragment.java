 ...
 */
public class RecommendVpFragment extends BaseMvpFragment<MoviePresenter> implements
...
//                getContext().startActivity(intent);
    ...
    public void showMovieData(List<MovieEntity> list) {
        ...
        for (MovieEntity movieEntity : list) {
            mMovieData.add(new MultipleItemEntity(MultipleItemEntity.LIST, 3, movieEntity));
        }
