//package com.jiumeng.movieheaven2.ui.activity;
//
...
//import com.jiumeng.movieheaven2.Base.BaseActivity;
...
//import com.jiumeng.movieheaven2.ui.views.comment.CommentsView;
//import com.jiumeng.movieheaven2.ui.views.comment.OnCommentClickListener;
//
...
//
//        String imgUrl = MyTextUtils.url2Id(mMovieDetail.url, true);
//        Glide.with(this).load(imgUrl).error(R.drawable.default_movie_image2).bitmapTransform(new BlurTransformation(this, 50)).into(picture);
...
//            if (mMovieDetail.jpgList.get(1) != null) {
//                Glide.with(this).load(mMovieDetail.jpgList.get(1)).into(ivImg2);
//            }
//
//        }
