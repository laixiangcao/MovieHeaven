 ...
 */
public class FloatingAutoHideDownBehavior2 extends CoordinatorLayout.Behavior<View> {
    private static final Interpolator INTERPOLATOR = new DecelerateInterpolator();
    private boolean mIsAnimatingOut = false;
    private boolean mIsScrollToBottom = false;

    public FloatingAutoHideDownBehavior2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FloatingAutoHideDownBehavior2() {
        super();
    }
    ...
    public boolean onStartNestedScroll(final CoordinatorLayout coordinatorLayout, final View child,
        ...
        // 滑动时隐藏软键盘
        UIUtils.hideSoftKeyboard(coordinatorLayout);
